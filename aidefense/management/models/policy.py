...
class Guardrail(BaseModel):
    ...
    items: List[GuardrailRule] = Field(default_factory=list, description="List of guardrail rules")
...
class Guardrails(BaseModel):
    ...
    items: List[Guardrail] = Field(default_factory=list, description="List of guardrails")
    paging: Paging = Field(default=None, description="Pagination information")
...
class Policy(BaseModel):
    ...
    guardrails: Optional[Guardrails] = Field(None, description="Guardrails associated with this policy")
...
class ListPoliciesRequest(BaseModel):
    ...
    sort_by: Optional[PolicySortBy] = Field(None, description="Field name to sort the policies returned")
    order: Optional[str] = Field(None, description="Sort order of the policies returned")
...
class AddOrUpdatePolicyConnectionsRequest(BaseModel):
    ...
    connections_to_associate: Optional[List[str]] = Field(None, description="List of connection IDs to be added or updated to a policy")
    connections_to_disassociate: Optional[List[str]] = Field(None, description="List of connection IDs to be removed from a policy")
